  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          'group relative shadow-s border-0 z-0 flex cursor-pointer items-center justify-center overflow-hidden [border-radius:var(--radius)] px-6 py-3 whitespace-nowrap text-white [background:var(--bg)]',
